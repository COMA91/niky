package kr.co.shop.common.utils;
...
public class UploadFileUtils {
	...
	public static String changeToAbsolutePate(String uploadPath, ServletContext sc) {
	...
	public static ResponseEntity<byte[]> showOrDownload(String uploadPath, String filename) {
		...
		try {
			if (mType != null) {
				String prefix = filename.substring(0, filename.indexOf("s_"));
				String suffix = filename.substring(filename.indexOf("s_") + 2);
