...
<div class="container">
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 text-center">
        <a class="blog-header-logo text-dark" href="#">Nikey</a>
      </div>
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between">
      <a class="p-2 text-muted" href="#">woman</a>
      <a class="p-2 text-muted" href="#">man</a>
      <a class="p-2 text-muted" href="#">shoes</a>
      <a class="p-2 text-muted" href="#">outdoor</a>
      <a class="p-2 text-muted" href="#">shirt</a>
      <a class="p-2 text-muted" href="#">pants</a>
      <a class="p-2 text-muted" href="#">new style</a>
      <a class="p-2 text-muted" href="#">old style</a>
      <a class="p-2 text-muted" href="#">order</a>
      <a class="p-2 text-muted" href="#">QnA</a>
      <a class="p-2 text-muted" href="#">board</a>
      <a class="p-2 text-muted" href="#">my page</a>
  ...
  <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark">
    <div class="col-md-6 px-0">
      <h1 class="display-4 font-italic">Welcome Nikey</h1>
      <p class="lead my-3">new generation</p>
      <p class="lead mb-0"><a href="#" class="text-white font-weight-bold">원하는 모든 옷이 한곳에</a></p>
    </div>
  </div>
  ...
  <div class="row mb-2">
    <div class="col-md-6">
      <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          <strong class="d-inline-block mb-2 text-primary">new style</strong>
          <h3 class="mb-0">신상품</h3>
          <div class="mb-1 text-muted">5월 상품</div>
          <p class="card-text mb-auto">이번 봄상품은 화사한 봄날에 맞게 뛰어난 색채감과 라이트한 느낌을 주는 아우터입니다.</p>
    ...
    <div class="col-md-6">
      <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          <strong class="d-inline-block mb-2 text-success">old style</strong>
